/* Variabel Layer */
var map, featureList, bataskabupatenSearch = [], admindesaSearch = [], pendudukkecSearch = [], longsorSearch = [], banjirSearch = [], banjirlaharSearch = [], cuacaekstrimSearch = [], gempabumiSearch = [], kebakarangedungpermukimanSearch = [], kebakaranlahanSearch = [], kekeringanSearch = [], letusangunungapiSearch = [], bencanalainSearch = [];
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" +
		...
		"<tr><th>Foto</th><td><img src='" + feature.properties.path_foto + "' width='200' /><br><br><a href='" + feature.properties.path_foto + "' target='_blank'>>> Lihat foto <<</a></td></tr>" +
...
/*var baseLayers = {
  ...
  //"Google Traffic": basemap6,
};
var groupedOverlays = {
  "Kejadian Bencana": {
    "<img src='assets/homepage/assets/icon/naturaldisaster32/longsor.png' width='24' height='24'>&nbsp;Longsor": longsorLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/banjir.png' width='24' height='24'>&nbsp;Banjir": banjirLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/banjirlahar.png' width='24' height='24'>&nbsp;Banjir Lahar": banjirlaharLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/gempabumi.png' width='24' height='24'>&nbsp;Gempabumi": gempabumiLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/cuacaekstrim.png' width='24' height='24'>&nbsp;Cuaca Ekstrim": cuacaekstrimLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/kebakaranlahan.png' width='24' height='24'>&nbsp;Kebakaran Hutan/Lahan": kebakaranlahanLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/kebakarangedungpermukiman.png' width='24' height='24'>&nbsp;Kebakaran Gedung/Permukiman": kebakarangedungpermukimanLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/kekeringan.png' width='24' height='24'>&nbsp;Kekeringan": kekeringanLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/letusangunungapi.png' width='24' height='24'>&nbsp;Letusan Gunungapi": letusangunungapiLayer,
	"<img src='assets/homepage/assets/icon/naturaldisaster32/bencanalain.png' width='24' height='24'>&nbsp;Kejadian lain": bencanalainLayer,
  },
  "Layer": {
    "Batas Kabupaten": bataskabupaten,
	"Batas Desa": admindesa,
	"Penduduk Kecamatan": pendudukkec,
...
$(document).one("ajaxStop", function () {
  ...
  /* Search Layer */
  var bataskabupatenBH = new Bloodhound({
    name: "BatasKabupaten",
    datumTokenizer: function (d) {
      return Bloodhound.tokenizers.whitespace(d.name);
    },
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    local: bataskabupatenSearch,
    limit: 10
  });
  ...
  var banjirlaharBH = new Bloodhound({
    name: "BanjirLahar",
    datumTokenizer: function (d) {
      return Bloodhound.tokenizers.whitespace(d.name);
    },
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    local: banjirlaharSearch,
    limit: 10
  });
  ...
  $("#searchbox").typeahead({
    ...
    name: "BatasKabupaten",
    displayKey: "name",
    source: bataskabupatenBH.ttAdapter(),
    templates: {
      header: "<h4 class='typeahead-header'>bataskabupaten</h4>"
    }
  }, {
    name: "AdminDesa",
    displayKey: "name",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/longsor.png' width='24' height='24'>&nbsp;Longsor</h4>",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/banjir.png' width='24' height='24'>&nbsp;Banjir</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "BanjirLahar",
    displayKey: "name",
    source: banjirlaharBH.ttAdapter(),
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/banjirlahar.png' width='24' height='24'>&nbsp;Banjir Lahar</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "CuacaEkstrim",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/cuacaekstrim.png' width='24' height='24'>&nbsp;Cuaca Ekstrim</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "Gempabumi",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/gempabumi.png' width='24' height='24'>&nbsp;Gempabumi</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "Kebakarangedungpermukiman",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/kebakarangedungpermukiman.png' width='24' height='24'>&nbsp;Kebakaran Gedung Permukiman</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "Kebakaranlahan",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/kebakaranlahan.png' width='24' height='24'>&nbsp;Kebakaran Hutan/Lahan</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "Kekeringan",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/kekeringan.png' width='24' height='24'>&nbsp;Kekeringan</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "Letusangunungapi",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/letusangunungapi.png' width='24' height='24'>&nbsp;Letusan Gunungapi</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
	name: "BencanaLain",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/icon/naturaldisaster32/bencanalain.png' width='24' height='24'>&nbsp;Cuaca Ekstrim</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}} - {{date}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/homepage/assets/img/globe.png' width='25' height='25'>&nbsp;GeoNames</h4>"
    }
