...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; 2020 <a href=<?= base_url(); ?> target="_blank">BPBD Kab. Wonosobo</a> &amp; Developed by <a href="http://www.sinaugis.com" target="_blank">SinauGIS</a>.</strong> <?php echo lang('footer_all_rights_reserved'); ?>.
            </footer>
        </div>
