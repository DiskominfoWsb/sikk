          ...
          <div class="col-md-12">
            <div class="box-info">
              ...
              <?php foreach ($informasi as $key) {?>
                <form class="form-horizontal" action="<?php echo base_url($module.'edit/'.$key->idinformasi)?>" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="judul" class="col-sm-2 control-label">Judul</label>

                      <div class="col-sm-10">
                        <input class="form-control" value="<?php echo $key->judul ?>" name="judul" id="judul" required="required">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control" name="content" id="content"><?php echo $key->content ?></textarea>
                      </div>
                    </div>
                  <?php } ?>
                  <!-- /.box-body -->
