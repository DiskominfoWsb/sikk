    ...
    <section class="content">
      ...
      <div class="row">
          <div class="box  col-md-12">
            ...
            <form class="form-horizontal" action="<?php echo base_url($module.'edit/'.$key->idjenisbencana)?>" method="post">
              <div class="box-body">
            <p><font color="red"><strong>Info:</strong> Anda dapat menambahkan beberapa data sekaligus dengan menggunakan koma (,) sebagai separator / pemisah.</font></p>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input value="<?=$key->jenisbencanaNama?>" class="form-control" name="nama" required="required" placeholder="data1, data2, data3, ..., dataN" type="text">
                  </div>
                </div>
                <?php } ?>
              <!-- /.box-body -->
