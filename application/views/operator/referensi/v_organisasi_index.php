                ...
                <?php foreach ($organisasi as $key) {?>
                  <tr>
                    <td><?=$key->orgNama?></td>
                      <td><?=$key->orgTelp?></td>         
                    <td>
                        <a href="<?php echo base_url($module.'edit/'.$key->idOrg)?>" class="btn btn-sm btn-warning">Edit</a> 
                        
                          <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-hapus<?php echo $key->idOrg?>">Hapus</button>   
                          <!-- modal  -->
                          <div class="modal fade" id="modal-hapus<?php echo $key->idOrg?>">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a href="<?php echo base_url($module.'delete/'.$key->idOrg)?>" type="button" class="btn btn-danger">Hapus</a>
                                </div>
                              </div>
                              <!-- /.modal-content -->
                            </div>
