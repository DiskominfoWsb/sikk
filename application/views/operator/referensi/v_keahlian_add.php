            ...
            <form class="form-horizontal" action="<?php echo base_url($module.'add')?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" name="kode" required="required" placeholder="Kode Keahlian" type="text">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" name="nama" required="required" placeholder="Nama Keahlian" type="text">
                  </div>
                </div>
                <div class="form-group">
