          ...
          <div class="box  col-md-12">
            ...
            <form class="form-horizontal" action="<?php echo base_url($module.'add')?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="penanggungjawab" class="col-sm-2 control-label">Penanggung Jawab</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" name="kontak" id="kontak"  type="text">
                  </div>
                </div>                     
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="number" required="required" name="jml" class="form-control">
                  </div>
                </div>
              <!-- /.box-body -->
