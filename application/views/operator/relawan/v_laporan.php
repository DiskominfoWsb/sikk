...
<body>
	...
	<ol style="list-style-type: upper-alpha;">
		...
		<br />
		<li><strong>Pengerahan Relawan</strong>
			<ol style="margin-left: 0.2in">
				<li>Hari			: <?php echo $hari;?></li>
				<li>Tanggal		: <?php echo date('d', strtotime($tgl));?> <?php echo $bulan[date('n', strtotime($tgl))];?> <?php echo date('Y', strtotime($tgl));?></li>
				<li>Lokasi		: <?php echo $lokasi;?></li>
				<li>Kumunitas	: <?php echo $komunitas;?></li>
				<li>Jumlah		: <?php echo $jumlah;?></li>
			</ol>
		</li>
		<br />
		<li><strong>Laporan pengerahan relawan :</strong><br />
			<?php echo $laporan;?>
		</li>
		<br />
